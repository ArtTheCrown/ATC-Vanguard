...
namespace ATC_Vanguard.Vanguard.others
{
    public class FindWordsGameSystem
    {
        ...
        private static readonly List<string> EnglishWords = new List<string>
        {
            ...
            "bear", "beat", "beautiful", "because", "become", "bed", "bedroom", "beer", "before", "begin",
            ...
            "confident", "conflict", "confuse", "congress", "connect", "connection", "conscious", "consider", "constant", "construction",
            ...
            "green", "grocery", "ground", "group", "grow", "growing", "growth", "guarantee", "guard", "guess",
            ...
            "letter", "level", "liberal", "library", "license", "lie", "life", "lifestyle", "lifetime", "lift",
            ...
            "rid", "ride", "rifle", "right", "ring", "rise", "risk", "river", "road", "rock",
